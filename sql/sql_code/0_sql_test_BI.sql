...
insert into test values (16.55555, 14.55555); 
select * from test;
...
create table sales(purchase_number int, date_of_purchase date not null, customer_id int, item_code varchar(10) not null);
...
create table customers(customer_id int, firtst_name varchar(255), last_name varchar(255), email_address varchar(255),
number_of_complaints int);
...
create table items(item_id varchar(255) primary key, item varchar(255), unit_price numeric(10,2),company_id varchar(255));
...
create table companies(company_id varchar(255) primary key, company_name varchar(255), headquarters_phone_number int(12));
